       ...
       <div className="flex">
        ...
        <main className="px-6 py-4 flex-grow">
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-4">
            ...
            <p className="mb-4">
              I hope you're all having a fantastic growing season! Today, I wanted to dive into the topic of sustainable
              pest management—something we all grapple with. Here are a few techniques I've been experimenting with, and
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-4">
            ...
            <h2 className="font-bold mb-2">The Importance of Crop Rotation for Soil Health</h2>
            <p className="mb-4">
              Crop rotation is a simple process that can have significant impacts on the health of your soil and the
              quality of your crops. Let's discuss the benefits and some effective strategies for crop rotation.
            </p>
            <Button className="text-blue-500 border-blue-500" variant="outline">
              Join the discussion
            </Button>
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-4">
            ...
            <h2 className="font-bold mb-2">Efficient Irrigation Techniques for Water Conservation</h2>
            <p className="mb-4">
              Water is a precious resource, and as farmers, we have a responsibility to use it wisely. Let's share some
              efficient irrigation techniques that can help conserve water on our farms.
            </p>
            <Button className="text-blue-500 border-blue-500" variant="outline">
