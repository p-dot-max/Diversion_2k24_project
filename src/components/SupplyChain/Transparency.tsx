    ...
    <div className="flex flex-col justify-center items-center bg-gradient-to-b from-emerald-200 to-green-50 min-h-screen w-full">
      <div className=" flex flex-col justify-center items-center h-screen w-full gap-5">
        ...
        <div className="w-full md:w-2/3 lg:w-1/3 h-2/3 bg-white bg-opacity-50 border-2 border-white rounded-xl">
          ...
          className="flex flex-col justify-center w-full h-full p-5 gap-3"
          >
            <h1 className="font-semibold text-3xl text-black">Add Your Crop Details</h1>
            <p className=" text-black text-sm text-wrap font-light pr-20 pb-5">This faucet transfers Test Tokens and Gas Tokens on Polygon PoS and zkEVM testnets and its parent chain (Goerli). Confirm details before submitting </p>
