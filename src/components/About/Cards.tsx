  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center p-6 gap-20 ">
      <img 
        ...
        className="rounded-custom-sm h-374 w-374"
      />
      <div className="md:ml-8 mt-6 md:mt-0 bg-custom-text-color p-9 md:w-3/5 h-374 w-374 rounded-custom-sm border">
        ...
        <div className="flex justify-center">
          <button className="mt-4 bg-black text-white py-1 px-4 rounded-custom-sm transition-colors">
            Get Started
          </button>
        </div>
      </div>
